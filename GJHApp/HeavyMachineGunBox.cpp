...
void HeavyMachineGunBox::Start()
{
	...
	CreateAnimation("Idle", "Item", 7, 7, 0.1f);
	CreateAnimation("PickUp", "Item", 8, 8, 0.05f, false);
...
void HeavyMachineGunBox::Update()
{
...
void HeavyMachineGunBox::ColEnter(GJHCollision* _This, GJHCollision* _Other)
{
...
void HeavyMachineGunBox::ColStay(GJHCollision* _This, GJHCollision* _Other)
{
	if (_Other->GetOrder() == (int)ContentsEnum::COLTYPE::PLAYER)
	{
		m_AniCollision->SetHitable(false);
...
void HeavyMachineGunBox::PickUpEffect()
{
