...
void ZombieThrowVomit::Start()
{
	...
	m_AniCollision = CreateCollision(COLGEOTYPE::CGT_RECT, { 0, 0 }, { 40, 20 }, ContentsEnum::COLTYPE::MONSTERBULLET);
...
void ZombieThrowVomit::ColEnter(GJHCollision* _This, GJHCollision* _Other)
{
...
void ZombieThrowVomit::CreateEndEffect()
{
	InstanceObjectData Data;
	Data.Size = GJHVector(256, 256);
	Data.Pos = GetPos();
...
void ZombieThrowVomit::SetAnimationData()
{
	float Delay = 0.06f;
