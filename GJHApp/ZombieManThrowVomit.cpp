...
#include "ZombieManThrowVomit.h"
#include "InstanceObject.h"

void ZombieManThrowVomit::Start()
{
	m_HP = 8;
	m_MoveSpeed = 400.f;
...
void ZombieManThrowVomit::Update()
{
	if (ColMap(50) == true)
	{
		CreateEndEffect();
...
void ZombieManThrowVomit::ColEnter(GJHCollision* _This, GJHCollision* _Other)
{
...
void ZombieManThrowVomit::CreateEndEffect()
{
	InstanceObjectData Data;
	Data.Size = GJHVector(256, 256);
	Data.Pos = GetPos();
...
void ZombieManThrowVomit::SetAnimationData()
{
	float Delay = 0.06f;
